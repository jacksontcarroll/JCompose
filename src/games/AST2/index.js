...
function preload() {
  // Images
  img_bg = loadImage("src/img/bg.png");
  img_bg2 = loadImage("src/img/space.png");
  img_player = loadImage("src/img/player.png");
  img_playernofire = loadImage("src/img/playernofire.png");
  img_pointer = loadImage("src/img/pointer.png");
  img_grass = loadImage("src/img/grass.png");
  img_shield = loadImage("src/img/shield.png");
  img_goldplayer = loadImage("src/img/playergold.png");
  img_asteroid = loadImage("src/img/asteroid.png");
  img_goldasteroid = loadImage("src/img/asteroidgold.png");
  img_laserspeed = loadImage("src/img/laserspeed.png");
  img_rocketspeed = loadImage("src/img/rocketspeed.png");
  img_firerate = loadImage("src/img/firerate.png");
  img_widerlaser = loadImage("src/img/widerlaser.png");
  img_shieldpreview = loadImage("src/img/shieldpreview.png");
  img_slowdown = loadImage("src/img/slowdown.png");
  img_boost = loadImage("src/img/boost.png");
  img_rainbowasteroids = loadImage("src/img/rainbowasteroids.png");
  img_silver = loadImage("src/img/silver.png");
  img_gold = loadImage("src/img/gold.png");
  img_cloud = loadImage("src/img/cloud.png");
  img_cloud2 = loadImage("src/img/cloud2.png");
  img_instructions = loadImage("src/img/instructions.png");
  img_redasteroid = loadImage("src/img/asteroidred.png");
  img_orangeasteroid = loadImage("src/img/asteroidorange.png");
  img_yellowasteroid = loadImage("src/img/asteroidyellow.png");
  img_greenasteroid = loadImage("src/img/asteroidgreen.png");
  img_aquaasteroid = loadImage("src/img/asteroidaqua.png");
  img_blueasteroid = loadImage("src/img/asteroidblue.png");
  img_purpleasteroid = loadImage("src/img/asteroidpurple.png");

  // Audio
  aud_mainMusic = loadSound("src/aud/main.mp3");
  aud_gameoverMusic = loadSound("src/aud/gameover.mp3");

  // Fonts
  font_LCD = loadFont("src/LCD_Solid.ttf");
