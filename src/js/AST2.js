...
function preload() {
  // Images
  img_bg = loadImage("../img/AST2_bg.png");
  img_bg2 = loadImage("../img/AST2_space.png");
  img_player = loadImage("../img/AST2_player.png");
  img_playernofire = loadImage("../img/AST2_playernofire.png");
  img_pointer = loadImage("../img/AST2_pointer.png");
  img_grass = loadImage("../img/AST2_grass.png");
  img_shield = loadImage("../img/AST2_shield.png");
  img_goldplayer = loadImage("../img/AST2_playergold.png");
  img_asteroid = loadImage("../img/AST2_asteroid.png");
  img_goldasteroid = loadImage("../img/AST2_asteroidgold.png");
  img_laserspeed = loadImage("../img/AST2_laserspeed.png");
  img_rocketspeed = loadImage("../img/AST2_rocketspeed.png");
  img_firerate = loadImage("../img/AST2_firerate.png");
  img_widerlaser = loadImage("../img/AST2_widerlaser.png");
  img_shieldpreview = loadImage("../img/AST2_shieldpreview.png");
  img_slowdown = loadImage("../img/AST2_slowdown.png");
  img_boost = loadImage("../img/AST2_boost.png");
  img_rainbowasteroids = loadImage("../img/AST2_rainbowasteroids.png");
  img_silver = loadImage("../img/AST2_silver.png");
  img_gold = loadImage("../img/AST2_gold.png");
  img_cloud = loadImage("../img/AST2_cloud.png");
  img_cloud2 = loadImage("../img/AST2_cloud2.png");
  img_instructions = loadImage("../img/AST2_instructions.png");
  img_redasteroid = loadImage("../img/AST2_asteroidred.png");
  img_orangeasteroid = loadImage("../img/AST2_asteroidorange.png");
  img_yellowasteroid = loadImage("../img/AST2_asteroidyellow.png");
  img_greenasteroid = loadImage("../img/AST2_asteroidgreen.png");
  img_aquaasteroid = loadImage("../img/AST2_asteroidaqua.png");
  img_blueasteroid = loadImage("../img/AST2_asteroidblue.png");
  img_purpleasteroid = loadImage("../img/AST2_asteroidpurple.png");

  // Audio
  aud_mainMusic = loadSound("../aud/AST2_main.mp3");
  aud_gameoverMusic = loadSound("../aud/AST2_gameover.mp3");

  // Fonts
  font_LCD = loadFont("../fonts/LCD_Solid.ttf");
